...
import { deleteTransaction } from '@trackify/api';
import { formatCurrency, formatDate } from '@trackify/utils';
          ...
          <div className="flex items-center gap-2 text-[10px] font-mono text-text-muted-40 tracking-tighter overflow-hidden min-w-0">
            ...
            {transaction.note && (
              <>
                ...
                <span className="inline-block truncate max-w-[120px] sm:max-w-[200px] md:max-w-none italic group-hover:text-text-secondary transition-colors">{transaction.note}</span>
              </>
            )}
          </div>
        </div>
