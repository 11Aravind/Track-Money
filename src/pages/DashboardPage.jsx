  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        {/* Temporal Analysis - Wide */}
        <div className="lg:col-span-8 order-1 card border-surface-border-light bg-surface-overlay/20">
        ...
        {/* Monthly Snapshot - Narrow, shows after Analysis on mobile */}
        <div className="lg:col-span-4 order-2 card border-surface-border-light bg-surface-card/40">
        ...
        {/* Recent Buffers - Wide */}
        <div className="lg:col-span-8 order-3 card border-surface-border-light bg-surface-overlay/20">
          <div className="flex items-center justify-between mb-8">
        ...
        {/* Traffic Distribution - Narrow */}
        <div className="lg:col-span-4 order-4 card border-surface-border-light bg-surface-overlay/20">
